---
title: Contributing
description: Guidance for Contributing to AFS Open Source Projects
...
---
Welcome and thank you for your interest in contributing to a AFS project! We recognize contributing to a project is no small feat! The guidance here aspires to help onboard new community members into how AFS-led projects tend to operate, and by extension, make the contribution process easier.

# How do I make a contribution?
Never made an open source contribution before? Wondering how contributions work in AFS projects? Here is a quick rundown!
...
If your question is of the broader AFS community, please [open a community discussion](https://github.com/AccentureFederal/community/discussions/new).

## Submitting a New Project Idea
 If you do not see a project, repository, or would like the community to consider working on a specific piece of technology, please [open a community ticket](https://github.com/AccentureFederal/community/issues/new).